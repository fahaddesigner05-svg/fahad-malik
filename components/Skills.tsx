...
const SKILLS = [
  { name: "UI/UX Design", level: 95, icon: "fa-bezier-curve", color: "text-cyan-400", glow: "group-hover:shadow-cyan-500/20", bg: "group-hover:bg-cyan-400/5" },
  { name: "Graphic Design", level: 90, icon: "fa-palette", color: "text-purple-400", glow: "group-hover:shadow-purple-500/20", bg: "group-hover:bg-purple-400/5" },
  { name: "Brand Identity", level: 85, icon: "fa-copyright", color: "text-pink-400", glow: "group-hover:shadow-pink-500/20", bg: "group-hover:bg-pink-400/5" },
  { name: "Web Design", level: 88, icon: "fa-laptop-code", color: "text-blue-400", glow: "group-hover:shadow-blue-500/20", bg: "group-hover:bg-blue-400/5" },
  { name: "Figma / Adobe XD", level: 98, icon: "fa-pen-nib", color: "text-cyan-400", glow: "group-hover:shadow-cyan-500/20", bg: "group-hover:bg-cyan-400/5" },
  { name: "Photoshop", level: 92, icon: "fa-image", color: "text-purple-400", glow: "group-hover:shadow-purple-500/20", bg: "group-hover:bg-purple-400/5" },
];
    ...
    <div className="container mx-auto px-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {SKILLS.map((skill, idx) => (
          <div key={idx} className={`glass-panel p-8 rounded-2xl border border-white/5 hover:border-white/20 transition-all duration-500 hover:-translate-y-3 group relative overflow-hidden ${skill.glow} ${skill.bg}`}>
